...
public class QLearning {    
    ...
    void runLearningLoop(QTable q) throws Exception {
        int moveCounter=0;
    ...
    void runTest(QTable q, int maxMoves) {
    	int moveCounter=0;
    ...
    public static void main(String s[]) {
        ...
        QTable agent = new QTable(app.getActionRange());
        int generations = 10;
        int maxMoves = 10;
